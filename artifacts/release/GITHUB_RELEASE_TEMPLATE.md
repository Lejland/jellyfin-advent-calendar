...
- Assigned movie count feedback after Save-triggered assignments and Reshuffle movies
...
1. Download `jellyfin-plugin-advent-calendar_1.5.4.0.zip`
...
- `jellyfin-plugin-advent-calendar_1.5.4.0.zip`
- `manifest.json`
