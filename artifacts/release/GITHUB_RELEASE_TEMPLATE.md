...
- Individual clear controls for Movie library and Movie tag selections
...
1. Download `jellyfin-plugin-advent-calendar_1.5.3.0.zip`
...
- `jellyfin-plugin-advent-calendar_1.5.3.0.zip`
- `manifest.json`
